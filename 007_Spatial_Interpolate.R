# Adapting RSpatial tutorial to our data set
# https://rspatial.org/analysis/4-interpolation.html
# Need to cite rspat, gstat, and terra packages for this
...
nn = interpolate(hi.raster, gs, debug.level = 0) #**# This is the challenge how do we snap to the HI raster? I suspect it has to do with how to set up the HI raster.
